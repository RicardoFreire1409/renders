      ...
      <div className="pt-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
                Nuestros <span className="bg-gradient-to-r from-teal-400 to-coral-400 bg-clip-text text-transparent">Servicios</span>
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
              {services.map((service, index) => (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-teal-500/20 hover:border-teal-500/40 transition-all"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Planes y <span className="text-coral-400">Precios</span>
              </h2>
              ...
              <div className="flex items-center justify-center space-x-4 mb-12">
                <span className={`text-lg ${billingType === 'hourly' ? 'text-white' : 'text-gray-400'}`}>
                  Por Hora
                </span>
                <button
                ...
                >
                  <div className={`absolute top-1 w-6 h-6 bg-teal-400 rounded-full transition-transform ${
                    billingType === 'monthly' ? 'translate-x-8' : 'translate-x-1'
                  }`}></div>
                </button>
                <span className={`text-lg ${billingType === 'monthly' ? 'text-white' : 'text-gray-400'}`}>
                  Mensual
                </span>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-coral-600/20 to-coral-800/20 p-8 rounded-2xl border border-coral-500/50 relative transform scale-105"
              >
                ...
                <div className="text-center">
                  ...
                  <div className="text-5xl font-bold text-coral-400 mb-2">
                  ...
                  <ul className="space-y-3 text-left mb-8">
                    <li className="flex items-center text-gray-300">
                      <Check className="h-5 w-5 text-coral-400 mr-3" />
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-2xl border border-yellow-500/30"
              >
                <div className="text-center">
        ...
        <section className="py-20 bg-gradient-to-b from-black to-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Equipos <span className="text-teal-400">Profesionales</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-white mb-2">Consola SSL</h3>
                  <p className="text-gray-400">Consola de mezcla analógica de 32 canales</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-white mb-2">Micrófonos Premium</h3>
                  <p className="text-gray-400">Neumann, AKG, Shure y más marcas top</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-white mb-2">Monitores Genelec</h3>
                  <p className="text-gray-400">Monitoreo de referencia para mezcla precisa</p>
                </div>
              </motion.div>
            </div>
          </div>
